...
\caption{Visualization of the embeddings learned by \methodname. Original embeddings dimensions were reduced to 3D using (a) PCA and (b) t-SNE. In both visualizations, we highlight the regions of \citeReq{\variedbackground} (green), \citeReq{\unnaturalskintone} (yellow), and \citeReq{\veiloverface} (red) requirements. Source: own elaboration.}
\label{fig:embviz}
\end{figure}
