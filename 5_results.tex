...
\caption{Example of preprocessed non-compliant images from the \citeReq{\washedout} requirement. Source: own elaboration.}
\label{fig:washedout}
\end{figure}
...
\caption{Example of a non-compliant image from the \citeReq{\variedbackground} requirement before and after the preprocessing step. Source: own elaboration.}
\label{fig:variedbgd}
\end{figure}
...
\caption{Example of a non-compliant image from the \citeReq{\hairacrosseyes} requirement before and after the resizing operation performed by the preprocessing step. Source: own elaboration.}
